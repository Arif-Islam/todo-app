...
const CreateTask = () => {
    ...
    const addTask = event => {
        ...
        toast.success('Task added! Please refresh to see newly added task');
        event.target.reset();
    }
    return (
        <div className='w-full md:w-3/4 xl:w-1/2 mx-auto shadow-lg rounded-lg pt-6 border'>
            <div className='flex flex-col items-center justify-center'>
                ...
                <form onSubmit={addTask} className='flex flex-col mb-6'>
                    <input onBlur={getTaskName} className='w-72 md:w-80 lg:w-96 xl:w-[450px] border-2 border-emerald-200 h-12 rounded focus:outline-emerald-500 p-2 mb-2' type="text" placeholder='Task Name' name="name" required />
